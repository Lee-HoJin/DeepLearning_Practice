...
for i in range(0, len(y) - seq_length):
    ...
    _y = y[i + seq_length]  # shape: [future_seq, 1]
    dataX.append(_x)
    dataY.append(_y)
...
print("Actual Price: ", df_last_actual_price.to_numpy())
...
plt.plot(testY[-30:], label="actual price")
plt.plot(test_predict[-30:], label="predicted price")
